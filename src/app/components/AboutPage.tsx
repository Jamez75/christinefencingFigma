    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pt-20 pb-6">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            {disciplines.map((discipline, idx) => (
              <div key={idx} className="bg-white rounded-lg shadow-md p-4 border-2 border-[var(--bg-subtle)]">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-[var(--brand-accent)]">
                <Swords size={24} className="text-[var(--brand-primary)]" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-[var(--brand-accent)]">
                <GraduationCap size={24} className="text-[var(--brand-primary)]" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-[var(--brand-accent)]">
                <Target size={24} className="text-[var(--brand-primary)]" />
              </div>
              <div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            {achievements.map((achievement, idx) => (
              <div key={idx} className="flex items-start gap-3 p-3 rounded-lg bg-[var(--bg-light)]">
                <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-[var(--brand-primary)]">
                  <Award size={20} className="text-white" />
                </div>
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="text-sm mb-1">{achievement.title}</h3>
                    <span className="text-xs px-2 py-1 rounded text-white flex-shrink-0 bg-[var(--brand-secondary)]">
                      {achievement.discipline}
                    </span>
                  </div>
                  <p className="text-xs text-[var(--text-primary)]">{achievement.year}</p>
                </div>
              </div>
            ))}
          </div>
